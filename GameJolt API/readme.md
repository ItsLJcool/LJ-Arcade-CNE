...
#### Parameters
> - `username` / `user_id` **[ string / int ]** - The username or user id of the user you are trying to fetch.

> [!NOTE]
> Username and User ID are the same thing.

#### Example
```haxe
NdllUtil.getFunction(ndllName, "fetchUser", 1)( "GameJolt Username / ID" );
```
